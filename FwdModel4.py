...
#TODO: comment this out if looking at vels
      ...
      #  for i in range(0, n_behavior):  # number of sigma values to test
       #     simParams['channel']['sigma'] = 0  # sigmaVals[i]
        ...
        # ecap_csv_name = FWDOUTPUTDIR + 'Dist0_5_low_density.csv'
        # ecap_csv_name = FWDOUTPUTDIR + 'Dist0_5_high_density.csv'
